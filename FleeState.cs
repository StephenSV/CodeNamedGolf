	...
	public class FleeState : BaseState
	{
		...
		protected override bool Reason(AIBehaviors fsm)
		{
			...
			case FleeMode.AwayFromNearestTaggedObject:
				...
				if (nearestObjectPosition != null) 
				{
					float sqrDist = (fsm.transform.position - nearestObjectPosition).sqrMagnitude;
		...
		public override Vector3 GetNextMovement (AIBehaviors fsm)
		{
			...
			case FleeMode.Direction:
				result = fsm.transform.position + fleeDirection * stopFleeDistance;
				break;
